...
### Technical Details
- Built with Spring Boot 3.5.7 and Java 21
- Uses ProcessBuilder for secure command execution
- Supports multiline commands and heredoc syntax
...
For detailed documentation, see [PROMPT.md](PROMPT.md)
